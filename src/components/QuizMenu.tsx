...
const QuizMenu = ({ currentLevel, totalScore, maxLevel, onStartLevel }: QuizMenuProps) => {
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold">{totalScore} points</span>
          </div>
        </div>
        ...
        {availableLevels.map(level => (
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">
              {level === currentLevel ? "Continue your progress" : "Review this level"}
            </p>
          </Card>
        ))}
